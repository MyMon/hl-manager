			...
			<div class="layui-fluid">
				<div class="layui-row">
					<div class="layui-col-md7" style="padding: 20px;">
						...
						<div class="layui-card" style="background-color: #d2d2d2;">
							...
							<div class="layui-card-body">
								...
								<div class="layui-col-md3" style="">
									...
									<div class="layui-col-md4 index-send-div">
									       <button type="button" class="layui-btn layui-btn-primary index-send">发布</button>
									    </div>
								</div>
					...
					<div class="layui-col-md3" style="padding: 20px;    margin-top: 6%;">
						<div class="layui-card">
							<div class="layui-card-header">世界热事件</div>
							<div class="layui-card-body">
						...
						<div class="layui-card">
							<div class="fly-panel fly-rank fly-rank-reply" id="LAY_replyRank">
								<h3 class="fly-panel-title">访客</h3>
								<dl>
									<dd><a href="/u/2430456"><img src="img/photo.png"><cite>HiTerry</cite><i>86次回答</i></a></dd>
									<dd><a href="/u/2430456"><img src="img/photo.png"><cite>HiTerry</cite><i>86次回答</i></a></dd>
									<dd><a href="/u/2430456"><img src="img/photo.png"><cite>HiTerry</cite><i>86次回答</i></a></dd>
									<dd><a href="/u/2430456"><img src="img/photo.png"><cite>HiTerry</cite><i>86次回答</i></a></dd>
									<dd><a href="/u/2430456"><img src="img/photo.png"><cite>HiTerry</cite><i>86次回答</i></a></dd>
